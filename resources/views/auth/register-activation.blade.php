                            ...
                            <div class="user-dashboard loader-holder">
                                <div class="user-holder">
                                    <ul class="restaurant-settings-nav progressbar-nav">
                                        ...
                                        <li class="active"><a href="register-payment-info.html" class="cond-restaurant-settings1">Payment Information</a></li>
                                        <li class="active"><a href="register-activation.html" class="cond-restaurant-settings1">Activation</a></li>
                                    </ul>
                                                ...
                                                <li>
                                                    <div class="activation-tab-message">
                                                        <div class="media-holder">
                                                            <figure>
                                                                <img src="assets/extra-images/thankyou-image.png" alt="Thank You">
                                                            </figure>
                                                        </div>
